                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg col-md-6 col-sm-6">
                            <div class="item wow bounceInLeft" data-wow-delay="0.4s">
                                <div class="thumb">
                                    <Link to="/product"><img src={shooter[shotNum].thumbnail} alt="" /></Link>
                                </div>
                                <div class="down-content">
                                    <span class="category">Shooter</span>
                                    <h4>{shooter[shotNum].title}</h4>
                                    <Link to="/shop">Explore</Link>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-6 wow bounceInLeft" data-wow-delay="0.2s">
                            <div class="item">
                                <div class="thumb">
                                    <Link to="/product"><img src={strategy[strNum].thumbnail} alt="" /></Link>
                                </div>
                                <div class="down-content">
                                    <span class="category">Strategy</span>
                                    <h4>{strategy[strNum].title}</h4>
                                    <Link to="/shop">Explore</Link>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-6 wow bounceInDown">
                            <div class="item">
                                <div class="thumb">
                                    <Link to="/product"><img src={mmorgp[mmorgpNum].thumbnail} alt="" /></Link>
                                </div>
                                <div class="down-content">
                                    <span class="category">MMORGP</span>
                                    <h4>{mmorgp[mmorgpNum].title}</h4>
                                    <Link to="/shop">Explore</Link>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-6 wow bounceInRight" data-wow-delay="0.2s">
                            <div class="item">
                                <div class="thumb">
                                    <Link to="/product"><img src={cards[0].thumbnail} alt="" /></Link>
                                </div>
                                <div class="down-content">
                        ...
                        <div class="col-lg col-md-6 col-sm-6 wow bounceInRight" data-wow-delay="0.4s">
                            <div class="item">
                                <div class="thumb">
                                    <Link to="/product"><img src={racing[racingNum].thumbnail} alt="" /></Link>
                                </div>
                                <div class="down-content">
                                    <span class="category">Racing</span>
                                    <h4>{racing[racingNum].title}</h4>
                                    <Link to="/shop">Explore</Link>
                                </div>
                            </div>
                        </div>
