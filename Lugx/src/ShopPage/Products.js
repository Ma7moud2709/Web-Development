        ...
        <div className="section trending">
            <div className="container">
                <ul className="trending-filter">
                    <li>
                        <Link className="is_active" to="/shop">Show All</Link>
                    </li>
                    <li>
                ...
                <div className="row trending-box">
                    {games.map((item) => (
                        <div className="animate__animated animate__zoomIn wow  col-lg-3 col-md-6 align-self-center mb-30 trending-items" key={item.id}>
